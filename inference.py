...
from train_distill import build_model
...
class config:
    ...
    emb_name = 'monologg/kobert' #'monologg/distilkobert'#'HanBert-54kN-torch'#'skt/kobert-base-v1'#'monologg/kobigbird-bert-base'  # 'bert-base-uncased' # ['bert-base-uncased', 'roberta-base']
    mawps_vocab = True
...
inference_print(config(),
                "/home/leegwang/project/KMWPS/develop/models/vocab1.p",
                "/home/leegwang/project/KMWPS/develop/models/vocab2.p",
                './models/bert12/n12_h768_i_3072_kobert.pth',
                device)
